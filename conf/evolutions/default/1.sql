...
create table "projects" ("id" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"owner" VARCHAR NOT NULL);
create table "rights" ("project" INTEGER NOT NULL,"user" VARCHAR NOT NULL,"read" BOOLEAN NOT NULL,"write" BOOLEAN NOT NULL);
alter table "rights" add constraint "pk_right" primary key("project","user");
create table "users" ("name" VARCHAR GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"email" VARCHAR NOT NULL,"password" VARCHAR NOT NULL);
