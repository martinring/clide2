...
create table "files" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"projectId" BIGINT NOT NULL,"path" VARCHAR NOT NULL,"deleted" BOOLEAN NOT NULL,"exists" BOOLEAN NOT NULL,"isDirectory" BOOLEAN NOT NULL,"parent" BIGINT);
...
create table "sessions" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"project" BIGINT NOT NULL,"activeFile" BIGINT,"active" BOOLEAN NOT NULL);
