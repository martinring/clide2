...
trait CodeMirrorConfiguration extends js.Object {
   ...
   */
  var specialCharPlaceholder: js.Function1[Char, HTMLElement] = ???
   ...
   */
  var resetSelectionOnContextMenu: Boolean = ???
