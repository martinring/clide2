...
object Worker extends js.Object {
  ...
  object DomGlobals extends js.GlobalScope {
    ...
    def setTimeout(handler: js.Any, timeout: js.Any, args: js.Any*): TimeoutHandle = ???
    def clearInterval(handle: TimeoutHandle): Unit = ???
    def setInterval(handler: js.Any, timeout: js.Any, args: js.Any*): TimeoutHandle = ???
    var URL: URL = _
    var MSApp: MSApp = _
    var onmspointerdown: js.Function1[js.Any, js.Any] = _
    var animationStartTime: js.Number = _
