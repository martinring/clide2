...
trait JQueryGenericPromise[T] extends Object {
  ...
  // FIXME: def then[U](onFulfill: Function1[T, JQueryGenericPromise[U]], onReject: Function1[Any, JQueryGenericPromise[U]]): JQueryGenericPromise[U] = ???
}

trait JQueryPromise[T] extends Object {
  // FIXME: def always(alwaysCallbacks: T*): JQueryPromise[T] = ???
  def always(alwaysCallbacks: Any*): JQueryPromise[T] = ???
  // FIXME: def done(doneCallbacks: T*): JQueryPromise[T] = ???
  def done(doneCallbacks: Any*): JQueryPromise[T] = ???
  // FIXME: def fail(failCallbacks: T*): JQueryPromise[T] = ???     
  def fail(failCallbacks: Any*): JQueryPromise[T] = ???
  // FIXME: def progress(progressCallbacks: T*): JQueryPromise[T] = ???
...
trait BaseJQueryEventObject extends Event {
  ...
  override def preventDefault() = ???
  var relatedTarget: Element = _
  var result: Any = _
  override def stopImmediatePropagation(): Unit = ???
...
trait JQueryStatic extends Object {
  ...
  // FIXME: def apply(elementArray: Array[Element]): JQuery = ???
  ...
  // FIXME: def when[T](deferreds: JQueryGenericPromise[T]*): JQueryPromise[T] = ???
  // FIXME: def when[T](deferreds: T*): JQueryPromise[T] = ???
  ...
  // FIXME: def merge[T](first: Array[T], second: Array[T]): Array[T] = ???
...
trait JQuery extends Object {
  ...
  def removeClass(className: String): JQuery = ???
  def removeClass(): JQuery = ???
  def removeClass(func: Function2[Any, Any, Any]): JQuery = ???
  def removeProp(propertyName: String): JQuery = ???
  def toggleClass(className: String, swtch: Boolean): JQuery = ???
  def toggleClass(className: String): JQuery = ???
  ...
  def on(events: String, selector: String, data: Any, handler: Function1[JQueryEventObject, Any]): JQuery = ???
  ...
  def on(events: String, selector: String, handler: Function1[JQueryEventObject, Any]): JQuery = ???
  def on(events: String, handler: Function1[JQueryEventObject, Any]): JQuery = ???
  ...
  def add(selectorOrHtml: String): JQuery = ???
