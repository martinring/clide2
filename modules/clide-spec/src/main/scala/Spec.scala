...
object Spec extends AssistantServer(SpecBehavior)

case class SpecBehavior(control: AssistantControl) extends AssistantBehavior {
  val mimeTypes = Set("text/x-spec")
